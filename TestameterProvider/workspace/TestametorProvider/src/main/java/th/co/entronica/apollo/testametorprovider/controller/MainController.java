...
public class MainController {
    ...
    public void newProject(MainForm mainForm) {
        //projectName = JOptionPane.showInputDialog(mainForm, "Please,Input project name.", "New Project", JOptionPane.OK_CANCEL_OPTION);
       
    }
    
    public void  showDialogChooser(MainForm mainForm) {
    ...
    public void showDialogOpenFile(MainForm mainForm){
